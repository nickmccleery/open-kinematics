"""
Positions class for managing point position data.

Replaces ad-hoc dict[PointID, np.ndarray] manipulation with a typed,
single-responsibility container. Simplifies solver and reduces shape bugs.
"""
